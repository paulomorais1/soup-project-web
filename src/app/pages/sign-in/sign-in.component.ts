...
export class SignInComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metatagService.updateMetatags({
      ...
      description:
        'Faça login como administrador para acessar e gerenciar os dados vitais da ONG Projeto Sopa. Gerencie outros administradores, voluntários e demais informações com segurança e eficiência.',
    });
  }
}
